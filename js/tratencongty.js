...
const writeStream = fs.createWriteStream('Q5.html');

// Thông tin về trang
const fromPage = 10; // Trang bắt đầu
const toPage = 20; // Trang kết thúc
...
for (let page = fromPage; page <= toPage; page++) {
  const link = `https://www.tratencongty.com/thanh-pho-ho-chi-minh/quan-5/?page=${page}`;
